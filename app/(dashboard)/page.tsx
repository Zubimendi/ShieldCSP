          ...
          <div className="bg-[#162a2e] border border-[#224349] rounded-xl overflow-hidden">
            <div className="p-6 border-b border-[#224349] flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button className="cursor-pointer text-xs font-bold px-3 py-1.5 rounded-lg bg-[#07b6d5] hover:brightness-110 text-white transition-all shadow-lg shadow-[#07b6d5]/10">
                  Export CSV
                </button>
                <button className="cursor-pointer text-xs font-bold px-3 py-1.5 rounded-lg bg-[#07b6d5] hover:brightness-110 text-white transition-all shadow-lg shadow-[#07b6d5]/10">
                  View All
