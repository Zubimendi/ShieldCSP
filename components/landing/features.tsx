  ...
  return (
    <section className="max-w-[1200px] mx-auto px-6 py-24">
      <div className="flex flex-col gap-4 mb-16 items-center text-center">
        ...
        <p className="text-slate-400 text-lg max-w-[600px]">Deploy robust security headers and monitor violations with AI-driven insights that scale with your infrastructure.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-8 rounded-2xl flex flex-col gap-6 group hover:border-[#07b6d5]/50 transition-all">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-slate-400 leading-relaxed">Automated policy generation based on live site behavior and global threat intelligence feeds.</p>
          </div>
        </div>
      </div>
    </section>
